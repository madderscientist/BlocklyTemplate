 ...
 */
export const save = function (workspace, name) {
  const codes = Blockly.serialization.workspaces.save(workspace);
  window.localStorage.name = codes;
}
 ...
 */
export const load = function (workspace, name) {
  const codes = window.localStorage?.getItem(name);
  if (codes) {
    Blockly.Events.disable();
    Blockly.serialization.workspaces.load(state, workspace, false);
